...
public class ArrayListTest {
	...
	public static void main(String[] args) {
		...
		PhoneLog log1 = new PhoneLog("You missed a call", LocalDate.now(), "Missed", "Pavan");
		PhoneLog log2 = new PhoneLog("You dialed a call", LocalDate.now(), "Dialed", "Sunil");
		PhoneLog log3 = new PhoneLog("You recieved a call", LocalDate.now(), "Recieved", "zmohan");
		PhoneLog log4 = new PhoneLog("You got a sms", LocalDate.now(), "Message In", "Jeeta");
